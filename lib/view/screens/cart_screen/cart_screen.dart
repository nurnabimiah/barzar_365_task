          ...
          builder: (cartController) {
            return Column(
              ...
              children: [
                ...
                Text("Shopping Cart ${cartController.cartItems.length}",style: myStyleInter(20.sp,AppColors.appBlackColor,FontWeight.w700,-0.48)),
                ...
                Text("Added Item ${cartController.cartItems.length} items",style: myStyleInter(20.sp,AppColors.appBlackColor,FontWeight.w700,-0.48)),
